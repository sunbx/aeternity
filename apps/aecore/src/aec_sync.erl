...
-record(pool_item, { height :: aec_blocks:height()
                   ...
                   , got :: false
                          | { aec_peers:peer_id()
                            , local | #{ key_block := aec_valid_block:block()
                                       , micro_blocks := [aec_valid_block:block()]
                                       , dir := backward
                                       }
                            }
                   }).
